...
kript = RC5(32, 12, b'testkey')
a = kript.encryptBlock(b'alexandr')

print(a)
print(kript.decryptBlock(a))
kript.encryptFile('input_Text.txt', 'file_output.txt')
kript.decryptFile('file_output.txt', 'decryptFile.txt')
